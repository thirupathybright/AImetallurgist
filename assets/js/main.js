(function($) {
    ...
    splitTitleLines.forEach(splitTextLine => {
        ...
        titleLine.from(itemSplitted.lines, {
            duration: 1,
            delay: 0.1,
            opacity: 0,
            rotationX: -50,
    ...
    let subTitleContainer = new SplitText(".tp_subtitle_anim", {
        type: "chars"
    });
    ...
    gsap.set(".tp_fade_bottom_footer", {
        y: 50,
        opacity: 0
    });
